...
\logo{{\tiny \copyright\ 1999-2017, Morten Hjorth-Jensen. Released under CC Attribution-NonCommercial 4.0 license}}
...
\begin{frame}[plain,fragile]
\frametitle{Simple Example, Block tied to a Wall, python code}
